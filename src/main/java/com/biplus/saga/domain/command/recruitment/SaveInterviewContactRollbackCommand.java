...
@TargetMessage("com.biplus.recruitment.domain.command.SaveInterviewContactRollbackCommand")
public class SaveInterviewContactRollbackCommand implements RetryableCommand, TenantAware {
