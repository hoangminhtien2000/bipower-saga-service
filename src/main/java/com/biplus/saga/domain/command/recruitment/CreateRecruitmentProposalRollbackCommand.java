...
@TargetMessage("com.biplus.recruitment.domain.command.CreateRecruitmentProposalRollbackCommand")
public class CreateRecruitmentProposalRollbackCommand implements RetryableCommand, TenantAware {
