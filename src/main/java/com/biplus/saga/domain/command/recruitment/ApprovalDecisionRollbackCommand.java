...
@TargetMessage("com.biplus.recruitment.domain.command.ApprovalDecisionRollbackCommand")
public class ApprovalDecisionRollbackCommand implements RetryableCommand, TenantAware {
