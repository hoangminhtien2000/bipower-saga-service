...
@NoArgsConstructor
@AllArgsConstructor
@TargetMessage("com.biplus.recruitment.domain.command.ApprovalDecisionCommand")
public class ApprovalDecisionCommand implements RetryableCommand, TenantAware {
