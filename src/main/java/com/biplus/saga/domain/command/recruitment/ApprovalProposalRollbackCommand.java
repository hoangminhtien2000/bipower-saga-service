...
@TargetMessage("com.biplus.recruitment.domain.command.ApprovalProposalRollbackCommand")
public class ApprovalProposalRollbackCommand implements RetryableCommand, TenantAware {
