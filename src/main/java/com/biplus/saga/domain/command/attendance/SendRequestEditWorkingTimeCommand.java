...
@NoArgsConstructor
@AllArgsConstructor
@TargetMessage("com.biplus.salary.domain.command.SendRequestEditWorkingTimeCommand")
public class SendRequestEditWorkingTimeCommand implements CompensatableCommand, Serializable {
