...
@TargetMessage("com.biplus.recruitment.domain.command.AssignCVReviewerRollbackCommand")
public class AssignCVReviewerRollbackCommand implements RetryableCommand, TenantAware {
