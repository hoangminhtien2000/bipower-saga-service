...
@NoArgsConstructor
@AllArgsConstructor
@TargetMessage("com.biplus.salary.domain.command.SendRequestWorkOutsideCommand")
public class SendRequestWorkOutsideCommand implements CompensatableCommand, Serializable {
