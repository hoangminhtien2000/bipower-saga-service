...
@NoArgsConstructor
@AllArgsConstructor
@TargetMessage("com.biplus.salary.domain.command.WorkingTimeUpdateCommand")
public class WorkingTimeUpdateCommand implements CompensatableCommand, Serializable {
