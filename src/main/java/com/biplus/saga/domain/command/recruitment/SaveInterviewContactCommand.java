...
@TargetMessage("com.biplus.recruitment.domain.command.SaveInterviewContactCommand")
public class SaveInterviewContactCommand implements RetryableCommand, TenantAware {
