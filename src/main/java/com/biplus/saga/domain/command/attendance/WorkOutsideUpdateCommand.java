...
@NoArgsConstructor
@AllArgsConstructor
@TargetMessage("com.biplus.salary.domain.command.WorkOutsideUpdateCommand")
public class WorkOutsideUpdateCommand implements CompensatableCommand, Serializable {
