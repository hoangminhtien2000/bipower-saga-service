...
@TargetMessage("com.biplus.recruitment.domain.command.SaveInterviewScheduleRollbackCommand")
public class SaveInterviewScheduleRollbackCommand implements RetryableCommand, TenantAware {
