...
@TargetMessage("com.biplus.recruitment.domain.command.SaveCVReviewRollbackCommand")
public class SaveCVReviewRollbackCommand implements RetryableCommand, TenantAware {
