...
@TargetMessage("com.biplus.recruitment.domain.command.SaveOnboardStatusRollbackCommand")
public class SaveOnboardStatusRollbackCommand implements RetryableCommand, TenantAware {
