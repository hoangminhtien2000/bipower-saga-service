...
@TargetMessage("com.biplus.recruitment.domain.command.InterviewEvaluationRollbackCommand")
public class InterviewEvaluationRollbackCommand implements RetryableCommand, TenantAware {
