...
@NoArgsConstructor
@AllArgsConstructor
@TargetMessage("com.biplus.contract.domain.command.ContractRollbackCommand")
public class ContractRollbackCommand implements CompensatableCommand, Serializable {
