...
@TargetMessage("com.biplus.recruitment.domain.command.DeleteCVReviewerRollbackCommand")
public class DeleteCVReviewerRollbackCommand implements RetryableCommand, TenantAware {
