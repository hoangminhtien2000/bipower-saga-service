...
@NoArgsConstructor
@AllArgsConstructor
@TargetMessage("com.biplus.salary.domain.command.ConfirmWorkOutsideCommand")
public class ConfirmWorkOutsideCommand implements CompensatableCommand, Serializable {
