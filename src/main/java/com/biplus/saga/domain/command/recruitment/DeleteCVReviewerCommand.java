...
@TargetMessage("com.biplus.recruitment.domain.command.DeleteCVReviewerCommand")
public class DeleteCVReviewerCommand implements RetryableCommand, TenantAware {
    private Long id;
