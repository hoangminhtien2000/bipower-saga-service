...
@Setter
@NoArgsConstructor
@SourceMessage("com.biplus.salary.domain.message.SendRequestWorkOutsideSuccessReply")
public class SendRequestWorkOutsideSuccessReply implements Serializable {
