...
@Setter
@NoArgsConstructor
@SourceMessage("com.biplus.salary.domain.message.SendRequestEditWorkingTimeSuccessReply")
public class SendRequestEditWorkingTimeSuccessReply implements Serializable {
